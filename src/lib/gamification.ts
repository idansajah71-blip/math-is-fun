...
export const BADGES = [
  { id: "first-lesson", name: "Langkah Pertama", icon: "🌱", desc: "Selesaikan materi pertama", rarity: "common" as const, condition: (p: UserProfile) => p.completedTopics.length >= 1 },
  { id: "five-lessons", name: "Semangat Belajar", icon: "🔥", desc: "Selesaikan 5 materi", rarity: "common" as const, condition: (p: UserProfile) => p.completedTopics.length >= 5 },
  { id: "ten-lessons", name: "Rajin Belajar", icon: "⭐", desc: "Selesaikan 10 materi", rarity: "rare" as const, condition: (p: UserProfile) => p.completedTopics.length >= 10 },
  { id: "all-smp", name: "Ahli SMP", icon: "🎓", desc: "Selesaikan semua materi SMP", rarity: "epic" as const, condition: (p: UserProfile) => p.completedTopics.length >= 20 },
  { id: "all-sma", name: "Ahli SMA", icon: "🏆", desc: "Selesaikan semua materi SMA", rarity: "epic" as const, condition: (p: UserProfile) => p.completedTopics.length >= 40 },
  { id: "streak-3", name: "Konsisten 3 Hari", icon: "🔥", desc: "Belajar 3 hari berturut-turut", rarity: "common" as const, condition: (p: UserProfile) => p.streak >= 3 },
  { id: "streak-7", name: "Konsisten Seminggu", icon: "💪", desc: "Belajar 7 hari berturut-turut", rarity: "rare" as const, condition: (p: UserProfile) => p.streak >= 7 },
  { id: "streak-30", name: "Dedicated", icon: "👑", desc: "Belajar 30 hari berturut-turut", rarity: "legendary" as const, condition: (p: UserProfile) => p.streak >= 30 },
  { id: "xp-100", name: "Seratus XP", icon: "💎", desc: "Kumpulkan 100 XP", rarity: "common" as const, condition: (p: UserProfile) => p.xp >= 100 },
  { id: "xp-500", name: "Lima Ratus XP", icon: "🏅", desc: "Kumpulkan 500 XP", rarity: "rare" as const, condition: (p: UserProfile) => p.xp >= 500 },
  { id: "xp-1000", name: "Seribu XP", icon: "🥇", desc: "Kumpulkan 1000 XP", rarity: "epic" as const, condition: (p: UserProfile) => p.xp >= 1000 },
  { id: "quiz-master", name: "Quiz Master", icon: "🧠", desc: "Skor quiz 100% di 5 topik", rarity: "rare" as const, condition: (p: UserProfile) => Object.values(p.quizScores).filter(s => s === 100).length >= 5 },
  { id: "gem-collector", name: "Gem Collector", icon: "💠", desc: "Kumpulkan 500 gems", rarity: "rare" as const, condition: (p: UserProfile) => p.gems >= 500 },
  { id: "speed-demon", name: "Speed Demon", icon: "⚡", desc: "Selesaikan quiz dalam 60 detik", rarity: "epic" as const, condition: () => false },
  { id: "perfect-week", name: "Perfect Week", icon: "🌟", desc: "Selesaikan 1 topik setiap hari selama seminggu", rarity: "legendary" as const, condition: () => false },
];

export const SHOP_ITEMS = [
  { id: "streak-freeze", name: "Streak Freeze", icon: "🧊", description: "Lindungi streak saat tidak belajar", price: 100, category: "powerup" as const },
  { id: "extra-heart", name: "Extra Heart", icon: "❤️", description: "+1 max heart", price: 200, category: "powerup" as const },
  { id: "double-xp", name: "Double XP", icon: "✨", description: "2x XP untuk 1 lesson", price: 150, category: "powerup" as const },
  { id: "avatar-robot", name: "Robot Avatar", icon: "🤖", description: "Avatar robot lucu", price: 300, category: "avatar" as const },
  { id: "avatar-cat", name: "Kucing Avatar", icon: "🐱", description: "Avatar kucing imut", price: 300, category: "avatar" as const },
  { id: "avatar-panda", name: "Panda Avatar", icon: "🐼", description: "Avatar panda menggemaskan", price: 300, category: "avatar" as const },
  { id: "avatar-fox", name: "Rubah Avatar", icon: "🦊", description: "Avatar rubah lucu", price: 300, category: "avatar" as const },
  { id: "confetti-effect", name: "Confetti Effect", icon: "🎊", description: "Confetti ekstra saat jawaban benar", price: 500, category: "effect" as const },
];
